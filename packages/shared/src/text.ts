const STOP = new Set([
  'the', 'a', 'an', 'and', 'or', 'of', 'for', 'with', 'my', 'our', 'new', 'in', 'on', 'to', 'by',
  'from', 'this', 'that', 'is', 'are', 'it', 'its', 'i', 'we', 'just', 'bought', 'got', 'have',
  'recall', 'recalls', 'recalled', 'due', 'hazard', 'risk', 'injury', 'serious', 'death',
]);
