...
function svg(body: string): Icon[] {
  ...
  return [{ src: `data:image/svg+xml;base64,${Buffer.from(doc).toString('base64')}`, mimeType: 'image/svg+xml', sizes: ['any'] }];
}
...
export const ICONS = {
  ...
  shield: svg('<path d="M12 3l8 3v6c0 5-3.5 8.5-8 9-4.5-.5-8-4-8-9V6l8-3z"/><path d="M12 8v4M12 16h.01"/>'),
  ...
  wrench: svg('<path d="M14.7 6.3a4 4 0 0 0 5 5l-7.4 7.4a2 2 0 0 1-2.8-2.8l7.4-7.4z"/><path d="M3 21l3-3"/>'),
