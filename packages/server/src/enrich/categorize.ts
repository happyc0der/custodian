...
const RULES: Array<[ItemCategory, string[]]> = [
  [
    'smoke_detector',
    ['smoke detector', 'smoke alarm', 'carbon monoxide', 'co detector', 'co alarm'],
  ],
  [
    'water_filter',
    ['water filter', 'fridge filter', 'refrigerator filter', 'brita', 'pitcher filter'],
  ],
  ['hvac_filter', ['hvac filter', 'furnace filter', 'air filter', 'ac filter']],
  [
    'car_seat',
    ['car seat', 'carseat', 'booster seat', 'infant seat', 'convertible seat', 'booster'],
  ],
  ...
  [
    'medication',
    ['medication', 'medicine', 'pills', 'tablets', 'prescription', 'insulin', 'inhaler'],
  ],
  [
    'medical_device',
    ['thermometer', 'blood pressure', 'glucose', 'cpap', 'nebulizer', 'monitor', 'pulse ox'],
  ],
  [
    'food',
    [
  ...
  [
    'tool',
    ['drill', 'saw', 'ladder', 'mower', 'lawn mower', 'chainsaw', 'generator', 'pressure washer'],
  ],
];
